...
void SVC_IRQHandler(void)                    __attribute__ ((weak, alias("Default_IRQHandler")));
void DebugMon_IRQHandler(void)               __attribute__ ((weak, alias("Default_IRQHandler")));
...
void USB_HP_CAN1_TX_IRQHandler(void)         __attribute__ ((weak, alias("Default_IRQHandler")));
void USB_LP_CAN1_RX0_IRQHandler(void)        __attribute__ ((weak, alias("Default_IRQHandler")));
...
void USBWakeUp_IRQHandler(void)              __attribute__ ((weak, alias("Default_IRQHandler")));
