...
//         {"LED_RED", {{((0x40000000UL + 0x00010000UL) + 0x00001800UL), 0}, GPIODriver::MODE::OUTPUT, 0, false, false, GPIODriver::TYPE::PUSH_PULL, GPIODriver::SPEED::MEDIUM, GPIODriver::PULL::NONE}},
